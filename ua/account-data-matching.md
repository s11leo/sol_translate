...
Для початку завантажте стартовий код з гілки `starter` [Link]("цього репозиторію" https://github.com/Unboxed-Software/solana-account-data-matching). Стартовий код включає програму з двома інструкціями та заготовку для тестового файлу.
